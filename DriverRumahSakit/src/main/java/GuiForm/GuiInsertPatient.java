 ...
 * @author adria
 */
public class GuiInsertPatient extends javax.swing.JFrame {

    /**
     * Creates new form Gui
     */
    public GuiInsertPatient() {
        initComponents();
    }
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addComponent(insuranceField, javax.swing.GroupLayout.PREFERRED_SIZE, 204, javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addGroup(layout.createSequentialGroup()
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            String query = "INSERT INTO patient (name, address, contact, insurance) VALUES ('" + nameField.getText() + "', '" + addressField.getText() + "', '" + contactFIeld.getText() + "', '" + insuranceField.getText() + "')";
            java.sql.Connection conn = (Connection)Config.DBConn();
            java.sql.PreparedStatement pr = conn.prepareStatement(query);
            pr.execute();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GuiInsertPatient.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new GuiInsertPatient().setVisible(true);
            }
        });
    }
